//icon
export { ReactComponent as WefloLogo } from './icon/WefloLogo.svg';
export { ReactComponent as GroupOut } from './icon/GroupOut.svg';
...
export { ReactComponent as Drone3 } from './images/Drone3.svg';
